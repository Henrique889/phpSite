...
$sql = "INSERT INTO fichaCaminhao VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stm = $conexao->prepare($sql);
$stm->bind_param('isssssssssssssssssssssssssssssssssssssss', $codigo, $placa, $extintor, $capaDeChuva, $Antena, $Radio, $Lona, $ColeteRefletivo,$Xrefletivo, $parDeluvas, $capacete, $GuardaChuva,$MarteloMadeira,$Documentos,$Acendedor,$CabosForca, $ChaveFixa,$Macaco,$FerroMacaco,$Triangulo,$ChaveRodas,$Tacografo,$tapetes,$caboAco,$catracas,$catracaMovel,$cordas,$Cinta,$qtsChaves,$lanterna,$OculosProtecao,$Controle,$KitEmergenciaG,$KitEmergenciaP,$Interclima,$chekInterclima,$lampadasDianteiras,$lampadasLaterais, $lampadasTraseiras, $Interior);
