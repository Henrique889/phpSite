...
$sql = "INSERT INTO cadastrar_VistoriaCaminhao VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stm = $conexao->prepare($sql);
$stm->bind_param('isssssssssssssssssssssssssssssssssssssss', $codigo, $placa,$nome,$data,$extintor, $capaDeChuva,$Antena,$Radio,$Lona, $ColeteRefletivo,$Xrefletivo, $parDeluvas, $capacete, $GuardaChuva, $MarteloMadeira, $Documentos, $Acendedor,$CabosForca,$ChaveFixa, $macaco, $ferroMacaco, $triangulo, $ChaveRodas,$Tacografo,$tapetes,$caboAco, $catracas, $catracaMovel, $cordas, $cinta,$qtsChaves, $lanterna, $KitEmergenciaP,$KitEmergenciaG, $Interclima,$InterclimaFuncionando, $LampadasDianteiras, $LampadasLaterais, $LampadasTraseiras, $Interior);
