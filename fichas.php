...
$sql = "INSERT INTO fichaVistoria VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stm = $conexao->prepare($sql);
$stm->bind_param('issssssssssssssssssssssssssssssssssss', $codigo, $placa, $extintor, $capaDeChuva, $Antena, $Radio, $Lona, $ColeteRefletivo,$Xrefletivo, $parDeluvas, $capacete, $GuardaChuva,$MarteloMadeira,$Documentos,$Acendedor,$CabosForca,$Macaco,$FerroMacaco,$Triangulo,$ChaveRodas,$Tacografo,$tapetes,$caboAco,$catracas,$catracaMovel,$cordas,$Cinta,$qtsChaves,$lanterna,$OculosProtecao,$Controle,$KitEmergenciaG,$KitEmergenciaP,$lampadasDianteiras,$lampadasLaterais, $lampadasTraseiras, $Interior);
